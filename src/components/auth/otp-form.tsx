...
export default function OtpForm() {
  ...
  return (
    ...
    <div
      className="flex flex-col items-center justify-center min-h-[calc(100svh-8rem)] p-6 sm:p-8"
      lang="fa"
    >
      <div className="w-full max-w-sm text-right mb-8">
        ...
        <p className="text-muted-foreground text-sm">
          {" "}
          {/* Smaller description */}
          خوب حالا یه اس ام اس حاوی کد 6 رقمی برات ارسال شده، بی زحمت اونو وارد
          کن و تمام!
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="w-full max-w-sm space-y-8">
        ...
        <div className="space-y-4">
          ...
          <Button
            type="submit"
            className="w-full text-lg p-0 h-14 rounded-full"
          ...
          <Button
            variant="outline"
            className="w-full text-lg p-0 h-14 rounded-full border-border hover:bg-muted"
            onClick={() => router.back()}
            disabled={isLoading}
            size="lg"
          >
