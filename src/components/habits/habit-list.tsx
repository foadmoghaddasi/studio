...
export default function HabitList() {
  ...
  if (activeHabits.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center text-center space-y-6 pb-10 min-h-[calc(100svh-11.5rem)]"> {/* Adjusted min-h */}
        ...
        <Link href="/create-habit" legacyBehavior>
          <Button className="text-xl px-4 py-6 rounded-full shadow-lg">
            ایجاد اولین عادت
          </Button>
        </Link>
      </div>
